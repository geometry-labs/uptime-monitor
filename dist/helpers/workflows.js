...
const introComment = async () => `# This file was generated by sudoblockio/uptime-monitor@${await (0, exports.getUptimeMonitorVersion)()}
#
# ===============================
...
jobs:
  release:
    ...
    steps:
      ...
      - name: Generate graphs
        uses: sudoblockio/uptime-monitor@${await (0, exports.getUptimeMonitorVersion)()}
        with:
          command: "graphs"
        env:
    ...
    steps:
      - name: Checkout
        ...
        with:
          ...
          token: \${{ secrets.GH_PAT }}
      - name: Update template
        uses: sudoblockio/uptime-monitor@master
        with:
          command: "update-template"
        env:
          GH_PAT: \${{ secrets.GH_PAT }}
