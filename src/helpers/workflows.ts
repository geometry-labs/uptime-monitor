...
const introComment = async () => `# This file was generated by sudoblockio/uptime-monitor@${await getUptimeMonitorVersion()}
#
# ===============================
...
jobs:
  release:
    ...
    steps:
      ...
      - name: Generate graphs
        uses: sudoblockio/uptime-monitor@${await getUptimeMonitorVersion()}
        with:
          command: "graphs"
        env:
