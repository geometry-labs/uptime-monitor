...
const introComment = async () => `# This file was generated by geometry-labs/uptime-monitor@${await getUptimeMonitorVersion()}
#
# ===============================
...
jobs:
  release:
    ...
    steps:
      ...
      - name: Generate graphs
        uses: geometry-labs/uptime-monitor@${await getUptimeMonitorVersion()}
        with:
          command: "graphs"
        env:
